...
<div class="content">
	...
	<div class="floatR" style="height:30px;">
		<input type="button" value="대금지급예정"> <input type="button" value="대금지급완료">
	</div>
	<div style="clear:both;">
		<table class="marketWait_table" border=1>
			...
			<tr>
				...
				<td rowspan="3">홍길동</td>
				<td rowspan="3">심청이</td>
				<td rowspan="3">은행입금</td>
				<td rowspan="3">배송완료<br>구매확정완료</td>
				<td rowspan="3">대금지급예정<br>[확인]</td>
				<td rowspan="3">[메모]</td>
			</tr>
			<tr>
				<td>ABCD0001</td>
			...
			<tr>
				<td colspan="2"></td>
				<td colspan="2">판매자 계좌정보</td>
				<td colspan="2">판매자 : 홍길동</td>
				<td colspan="2">예금주 : 홍길동</td>
				<td colspan="2">우리 00-00000-000</td>
				<td colspan="2">지급액:25,000원</td>
			</tr>
