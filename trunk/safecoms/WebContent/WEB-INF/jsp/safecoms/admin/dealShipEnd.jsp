...
<div class="content">
	...
	<div class="floatR" style="height:30px;">
		<input type="button" value="구매확정대기"> <input type="button" value="미도착"> <input type="button" value="환불요청">
	</div>
	<div style="clear:both;">
		<table class="marketWait_table" border=1>
			...
			<tr>
				...
				<td rowspan="3">홍길동</td>
				<td rowspan="3">심청이</td>
				<td rowspan="3">배송완료</td>
				<td rowspan="3">구매확정대기중</td>
				<td rowspan="3">[메모]</td>
			</tr>
			<tr>
				<td>ABCD0001</td>
