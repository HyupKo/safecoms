...
<div class="content">
	...
	<div class="floatR" style="height:30px;">
		<input type="button" value="1주일"> <input type="button" value="월단위"> <input type="text" size="10">~<input type="text" size="10">
	</div>
	<div style="clear:both;">
		<table class="marketWait_table" border=1>
			...
			<tr>
				...
				<td rowspan="3">2013-02-06<br>08:25</td>
				<td rowspan="3">2013-02-10<br>14:15</td>
			</tr>
			<tr>
				<td>ABCD0001</td>
				<td>대분류</td>
