...
<div class="content">
	...
	<div class="floatR" style="height:30px;">
		<input type="button" value="승인취소중"> <input type="button" value="승인취소완료"> <input type="button" value="송금대기"> <input type="button" value="송금완료">
	</div>
	<div style="clear:both;">
		<table class="marketWait_table" border=1>
			...
			<tr>
				...
				<td rowspan="3">홍길동</td>
				<td rowspan="3">심청이</td>
				<td rowspan="3">거래취소<br>(신용카드)</td>
				<td rowspan="3">승인취소요청중<br>2013/02/06 17:15</td>
				<td rowspan="3">[메모]</td>
			</tr>
			<tr>
				<td>ABCD0001</td>
			...
			<tr>
				...
				<td rowspan="3">홍길동</td>
				<td rowspan="3">심청이</td>
				<td rowspan="3">거래취소<br>(은행입금)</td>
				<td rowspan="3">대금송금확인<br>2013/02/06 17:15</td>
				<td rowspan="3">[메모]</td>
			</tr>
			<tr>
				<td>ABCD0001</td>
