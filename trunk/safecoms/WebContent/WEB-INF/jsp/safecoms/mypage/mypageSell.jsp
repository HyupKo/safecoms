...
<div class="content">
	...
	<div class="mypage_navigations">
		<ul>
			...
			<li class="select_blue"><a onclick="">판매관련</a></li>
			...
			<tbody>
				<tr>
					<td>
						<p>2012-01-11</p>
						<p>판매금액 : 00,000</p>
						<p class="select_green"><a onclick="">내용/가격 수정하기 ▶</a></p>
					</td>
					<td>
					...
					<td>
						<span class="select_blue">판매중</span>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<span class="red bold">환불요청 중</span><br>
						<span class="red">환불과정 안내 / 환불수락</span>
					</td>
				</tr>
			</tbody>
		</table>
