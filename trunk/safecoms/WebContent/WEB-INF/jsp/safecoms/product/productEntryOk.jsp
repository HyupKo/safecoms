...
<div id="wrap">
	<div class="content">
		...
		<p class="mL5"><strong><span class="green">&gt;</span><span class="blue">상품등록 완료</span></strong></p>
		...
		<div>
			<center>
				<img alt="목록보기" src="/images/btn/join046.gif" onclick="location.href='/safecoms/product/productList'">
				<img alt="홈으로" src="/images/btn/join051.gif" onclick="location.href='/safecoms/index'">
			</center>
		</div>
	</div>
</div>
